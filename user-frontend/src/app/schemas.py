...
class EventSchema(Schema):
    ...
    host_id = fields.Str()
    tournament_id = fields.Str(allow_none=True)
    team_a_id = fields.Str(allow_none=True)
    team_b_id = fields.Str(allow_none=True)
